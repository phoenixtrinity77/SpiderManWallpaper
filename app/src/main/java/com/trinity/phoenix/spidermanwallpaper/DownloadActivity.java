...
public class DownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdView adView2 = (AdView)findViewById(R.id.ironmanadView10);
        AdView adView3 = (AdView)findViewById(R.id.ironmanadView11);
        AdView adView4 = (AdView)findViewById(R.id.ironmanadView12);
        AdView adView5 = (AdView)findViewById(R.id.ironmanadView13);
        AdView adView6 = (AdView)findViewById(R.id.ironmanadView14);
        AdView adView7 = (AdView)findViewById(R.id.ironmanadView15);
        AdView adView8 = (AdView)findViewById(R.id.ironmanadView16);
        AdView adView18 = (AdView)findViewById(R.id.ironmanadView18);
